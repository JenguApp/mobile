...
import {LocationsMapPage} from './locations-map.page';

describe('LocationsMapPage', () => {
    let component: LocationsMapPage;
    let fixture: ComponentFixture<LocationsMapPage>;
    let alertController;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(LocationsMapPage);
