 ...
 */
@Component({
    selector: 'app-peer-to-peer-home',
    templateUrl: 'peer-to-peer-home.page.html',
    styleUrls: ['peer-to-peer-home.page.scss'],
})
export class PeerToPeerHomePage extends CanBeHomePage implements OnInit {
