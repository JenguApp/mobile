...
describe('PeerToPeerHomePage', () => {
    let component: PeerToPeerHomePage;
    let fixture: ComponentFixture<PeerToPeerHomePage>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PeerToPeerHomePage);
